...
public partial class Team122LibraryContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        ...
        if (!optionsBuilder.IsConfigured)
            optionsBuilder.UseMySql("server=atr.eng.utah.edu;user id=u1352501;password=pwd;database=Team122Library", Microsoft.EntityFrameworkCore.ServerVersion.Parse("10.11.8-mariadb"));
    }       
