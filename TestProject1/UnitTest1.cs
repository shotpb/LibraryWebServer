...
namespace TestProject1
{
    public class UnitTest1
    {
        ...
        Team122LibraryContext MakeTinyDB()
        {
            var contextOptions = new DbContextOptionsBuilder<Team122LibraryContext>()
            .UseInMemoryDatabase("LibraryControllerTest")
            .ConfigureWarnings(b => b.Ignore(InMemoryEventId.TransactionIgnoredWarning))
            .UseApplicationServiceProvider(NewServiceProvider())
            .Options;

            var db = new Team122LibraryContext(contextOptions);
        ...
        public void Test1()
        {
            ...
            Team122LibraryContext db = MakeTinyDB();
